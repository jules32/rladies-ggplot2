...
### Plot California National Parks by color over time
...
Finally, if you still have time, explore the many arguments of [`theme`](https://ggplot2.tidyverse.org/reference/theme.html) which can be used to more tightly control theme elements.
